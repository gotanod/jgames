...
public class ModelMVPIndicesTextureOBJLight implements GLEventListener {
	...
	private static final int ATTRIB_MATERIAL_AMBIENT = 10;
	private static final int ATTRIB_MATERIAL_DIFFUSE = 11;
	private static final int ATTRIB_MATERIAL_SPECULAR = 12;
	private static final int ATTRIB_MATERIAL_SHININESS = 13;
	private static final int ATTRIB_EYE_POSITION = 14;
	
	private boolean isInitialized = false;
	
	public ModelMVPIndicesTextureOBJLight() {
		loadModelData();
	}
	...
	private void initialize(GLAutoDrawable drawable) {
		...
		tex = ImageFile.loadFlippedImageFile("res/drawable/white.png");
	...
	private void draw(GLAutoDrawable drawable) {
		...
		M4f M = m4World.clone().scale(0.18f, 0.18f, 0.18f).rotateYaxisCCW(angleRadY).rotateXaxisCCW(0.4f).setTranslate(1.0f,  0.45f,  -3.0f);
