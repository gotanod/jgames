...
public class RenderGeneric implements Model {
	...
	public RenderGeneric(V3f position, V3f scale, RawOBJ model, RawImage textureImage, Camera camera, Light light, M4f projection) {
...
//        gl.glTexParameteri(GL4ES3.GL_TEXTURE_2D, GL4ES3.GL_TEXTURE_MAG_FILTER,   GL4ES3.GL_NEAREST_MIPMAP_LINEAR);	// up
//        gl.glTexParameteri(GL4ES3.GL_TEXTURE_2D, GL4ES3.GL_TEXTURE_MIN_FILTER,  GL4ES3.GL_NEAREST_MIPMAP_LINEAR);	// down
