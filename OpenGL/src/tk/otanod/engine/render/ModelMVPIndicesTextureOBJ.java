...
public class ModelMVPIndicesTextureOBJ implements GLEventListener {
	...
	public ModelMVPIndicesTextureOBJ() {
		loadModelData();
	}
	...
	private void loadModelData() {
		...
		RawOBJ model = OBJLoader.load("res/models/stall.obj");
//		RawOBJ model = OBJLoader.load("res/models/dragon.obj");
	...
	private float eyeZMax = 3.0f;
		
	// World matrix
	private M4f m4World = new M4f();
	private float angleRadY = 3.14f;							// we will rotate the model around Y axis
